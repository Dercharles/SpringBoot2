package com.yang.mongodb.util;

import com.mongodb.*;
import com.yang.common.modules.props.PropsKeys;
import com.yang.common.modules.props.PropsUtil;
import com.yang.common.modules.string.GetterUtil;
import com.yang.mongodb.domain.Pagination;
...
public class MongoManager {
	...
	public static final String DB_NAME = GetterUtil.getString(PropsUtil.getProperty(PropsKeys.MONGODB_NAME_HOST),"letsdesk");
...
//			options.threadsAllowedToBlockForConnectionMultiplier = blockSize;
                _log.warn("mongo init! host:"+ip+",port:"+port+",ConnectionsPerHost:"+options.getConnectionsPerHost());
            }
        }catch (Exception e){
	...
	public static DBCollection getMessge()
			throws UnknownHostException,MongoException{
		return getDB().getCollection(MESSAGE);
	}
