...
public class FileUtil {
	...
	public static com.example.springboot2.yang.common.file.File getFile() {
		return _file;
	}
...
//	}
	...
	public static void mkdirs(String pathName,String role) {
		getFile().mkdirs(pathName,role);
	}
	...
	public static void writeOpen(String fileName, String s,String role) throws IOException {
		getFile().writeOpen(fileName, s, role);
	}
	...
	public static void setFile(com.example.springboot2.yang.common.file.File file) {
		_file = file;
	}

	private static com.example.springboot2.yang.common.file.File _file = FileImpl.getInstance();
	 ...
	 * @return
	 */
	public static boolean GenerateImage(String imgStr,String filePathNamr) {
		...
		try
		{
			...
			//生成jpeg图片
			OutputStream out = new FileOutputStream(filePathNamr);
			out.write(b);
			out.flush();
			out.close();
			return true;
