...
import com.example.springboot2.yang.common.constant.ContentTypes;
...
import com.example.springboot2.yang.common.modules.time.Time;
import com.example.springboot2.yang.common.modules.validate.Validator;
import com.example.springboot2.yang.common.security.password.PwdGenerator;
 ...
 * @author visionet
 */
public class FileImpl implements com.example.springboot2.yang.common.file.File {
...
//	}
	...
	public void mkdirs(String pathName,String role) {
		File file = new File(pathName);
		file.mkdirs();
	...
	public String createTempFileName(String extension) {
		...
		sb.append(PropsUtil.getProperty("java.io.tmpdir"));
	...
	public void writeOpen(String fileName, String s,String role) throws IOException {
		write(new File(fileName), s, false, false,role);
	}

	public void write(File file, String s, boolean lazy, boolean append) throws IOException {
		// TODO Auto-generated method stub
		write(file, s, lazy, append,null);
	}

	public void write(File file, String s, boolean lazy, boolean append, String role)
			throws IOException {
		// TODO Auto-generated method stub

		if (file.getParent() != null) {
			SetFileRole(file.getParentFile(),role);
	...
	private static void SetFileRole(File file,String role){
		if(role!=null){
			if(role.contains("r")) {
			...
			if(role.contains("x") || file.isDirectory()){
