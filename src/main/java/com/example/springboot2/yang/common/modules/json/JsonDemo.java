package com.example.springboot2.yang.common.modules.json;
...
//	@XmlType(propOrder = { "name", "id" })
	...
	public void customConverter() {
		...
		jsonUser.setName("foo");
		jsonUser.setSalary(new Money(1.2));

		String jsonString = newMapper.toJson(jsonUser);

		assertEquals("{\"name\":\"foo\",\"salary\":\"1.2\"}", jsonString);

		// from
		JsonUser resultJsonUser = newMapper.fromJson(jsonString, JsonUser.class);
		assertEquals(Double.valueOf(1.2), resultJsonUser.getSalary().value);
