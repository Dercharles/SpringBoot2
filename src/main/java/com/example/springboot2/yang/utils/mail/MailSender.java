...
public class MailSender {
    ...
    public MailInfo getMailInfo() {
        ...
        info.setMailHost("smtp.263.net");
        info.setMailPort("25");
        info.setUsername("dapang@visionet.com.cn");
        info.setPassword("abc2016");
        info.setNotifyTo("yangpeng@visionet.com.cn;");
        info.setSubject("English test");
        info.setContent("中文测试");
